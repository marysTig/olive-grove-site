...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Questions fréquentes sur nos huiles d'olive, la livraison et le paiement." },
...
function Faq() {
  ...
  const faqs = lang === "ar"
    ...
    : [
        ...
        { q: "Comment conserver l'huile ?", a: "Dans un endroit frais et à l'abri de la lumière." },
        { q: "Puis-je retourner un produit ?", a: "Oui, contactez-nous dans les 48h suivant la réception." },
      ];
  return (
    <StoreLayout>
