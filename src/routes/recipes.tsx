...
export const Route = createFileRoute("/recipes")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Des idées de recettes méditerranéennes pour sublimer notre huile d'olive.",
      },
...
function Recipes() {
  ...
  const recipes = fr
    ? [
        {
          t: "Pain à l'huile d'olive",
          d: "Trempez du pain rustique dans notre huile avec un peu de sel et d'origan.",
        },
        {
          t: "Salade méditerranéenne",
          d: "Tomates, olives, feta et un filet généreux d'huile extra vierge.",
        },
