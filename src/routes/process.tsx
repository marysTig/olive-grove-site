  ...
  head: () => ({
    meta: [
      { title: "Notre Processus — Lem3ansra n Jeddi" },
      {
        name: "description",
        content:
          "De la récolte à la mise en bouteille : découvrez notre processus d'extraction à froid.",
      },
      { property: "og:title", content: "Notre Processus — Lem3ansra n Jeddi" },
      {
        property: "og:description",
        content: "De la récolte à la mise en bouteille, extraction à froid.",
      },
    ],
  }),
  component: Process,
  ...
  const steps = [
    {
      ...
      d:
        lang === "fr"
          ? "Cueillette manuelle des olives à maturité."
          : "قطف الزيتون يدويًا عند النضج.",
    },
    {
      n: t("process_2"),
      d: lang === "fr" ? "Nettoyage et tri soigneux des fruits." : "تنظيف وفرز دقيق للثمار.",
    },
    {
      n: t("process_3"),
      d:
        lang === "fr"
          ? "Extraction à froid pour préserver les arômes."
          : "عصر على البارد للحفاظ على النكهات.",
    },
    {
      n: t("process_4"),
      d: lang === "fr" ? "Filtrage naturel de l'huile." : "تصفية طبيعية للزيت.",
    },
    {
      n: t("process_5"),
      d: lang === "fr" ? "Mise en bouteille protectrice." : "تعبئة تحمي الزيت.",
    },
    {
      n: t("process_6"),
      d: lang === "fr" ? "Livraison rapide et soignée." : "توصيل سريع وبعناية.",
    },
  ];
  return (
    <StoreLayout>
